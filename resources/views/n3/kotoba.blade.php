...
<head>
    ...
    <title>Kosakata N3 - Watashi no Nihongo</title>
    ...
    <style>
        :root {
            ...
            --primary: #10b981; /* Emerald accent for Kotoba */
...
<body>
    <div class="container">
        ...
        @if(count($kotobas) === 0)
            <div class="empty-state">
                <h3>Belum ada Kosakata N3</h3>
                <p>Data Kosakata N3 di database masih kosong.</p>
            ...
            <div class="flashcard-container">
                <div class="flashcard" id="flashcard" onclick="toggleReveal()">
                    ...
                    <div class="card-face front">
                        <div class="word-char" id="wordFront">---</div>
                    </div>
                    <!-- Back -->
                    <div class="card-face back">
                        <div class="reading" id="readingBack">---</div>
                        <div class="word-char" id="wordBack" style="font-size: 2.5rem; color: var(--primary);">---</div>
    ...
    @if(count($kotobas) > 0)
        <script>
            ...
            let kotobas = [];
            let masteredIds = JSON.parse(localStorage.getItem('mastered_kotoba_n3') || '[]');
            ...
            function applyFilter() {
                let remaining = allKotobas.filter(k => !masteredIds.includes(k.id));

                if (remaining.length === 0 && allKotobas.length > 0) {
                    alert("Selamat! Semua kosakata N3 telah diingat. Progress akan direset.");
                    masteredIds = [];
                    localStorage.removeItem('mastered_kotoba_n3');
                    remaining = [...allKotobas];
                }
            ...
            function markAsMastered() {
                ...
                localStorage.setItem('mastered_kotoba_n3', JSON.stringify(masteredIds));
                applyFilter();
            }
            ...
            function nextCard() { 
                ...
                flashcard.classList.remove('is-flipped'); 
                btnReveal.textContent = 'Reveal'; 
                currentIndex = (currentIndex + 1) % kotobas.length; 
                updateCardContent(); 
            }
            ...
            function prevCard() { 
                ...
                flashcard.classList.remove('is-flipped'); 
                btnReveal.textContent = 'Reveal'; 
                currentIndex = (currentIndex - 1 + kotobas.length) % kotobas.length; 
                updateCardContent(); 
            }
